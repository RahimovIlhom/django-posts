...
urlpatterns = [
    ...
    path('post/<str:post_id>/like/', post_like_view, name='like-post'),
    path('comment/send/<pk>/', send_comment, name='send-comment'),
    path('comment/<str:comment_id>/like/', comment_like_view, name='like-comment'),
    path('comment/<str:comment_id>/delete/', comment_delete_view, name='comment-delete'),
    path('reply/send/<pk>/', send_reply, name='send-reply'),
    path('reply/<str:reply_id>/like/', reply_like_view, name='like-reply'),
